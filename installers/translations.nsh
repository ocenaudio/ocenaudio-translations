...
LangString StrOcenInstalledUptodate ${LANG_ENGLISH}			"${PRODUCT_NAME_LABEL} ${PRODUCT_VERSION} is already installed.$\nDo you want to reinstall it?"
!ifndef OPT_REMOVE_LANGUAGES
LangString StrOcenInstalledUptodate ${LANG_FRENCH}			"${PRODUCT_NAME_LABEL} ${PRODUCT_VERSION} déjà installé.$\nVoulez-vous le réinstaller?"
LangString StrOcenInstalledUptodate ${LANG_GERMAN}			"${PRODUCT_NAME_LABEL} ${PRODUCT_VERSION} ist bereits installiert.$\nMöchten Sie es installieren?"
LangString StrOcenInstalledUptodate ${LANG_ITALIAN}			"${PRODUCT_NAME_LABEL} ${PRODUCT_VERSION} è già installato.$\nVuoi reinstallarlo?"
LangString StrOcenInstalledUptodate ${LANG_PortugueseBR}	"O ${PRODUCT_NAME_LABEL} ${PRODUCT_VERSION} já está instalado.$\nDeseja reinstalá-lo?"
LangString StrOcenInstalledUptodate ${LANG_SPANISH}			"${PRODUCT_NAME_LABEL} ${PRODUCT_VERSION} ya está instalado.$\n¿Desea reinstalarlo?"
!endif

LangString StrOcenAskInstallNewer ${LANG_ENGLISH}			"${PRODUCT_NAME_LABEL} will be updated to version ${PRODUCT_VERSION}.$\nWould like to proceed?"
!ifndef OPT_REMOVE_LANGUAGES
LangString StrOcenAskInstallNewer ${LANG_FRENCH}			"${PRODUCT_NAME_LABEL} sera mise à jour vers la version ${PRODUCT_VERSION}.$\nVoulez-vous poursuivre?"
LangString StrOcenAskInstallNewer ${LANG_GERMAN}			"${PRODUCT_NAME_LABEL} wird auf version ${PRODUCT_VERSION} aktualisiert werden.$\nMöchten Sie den vorgang fortsetzen?"
LangString StrOcenAskInstallNewer ${LANG_ITALIAN}			"${PRODUCT_NAME_LABEL} verrà aggiornato alla versione ${PRODUCT_VERSION}.$\nVuoi procedere?"
LangString StrOcenAskInstallNewer ${LANG_PortugueseBR}		"O ${PRODUCT_NAME_LABEL} será atualizado para versão ${PRODUCT_VERSION}.$\nGostaria de continuar?"
LangString StrOcenAskInstallNewer ${LANG_SPANISH}			"${PRODUCT_NAME_LABEL} será actualizado a la versión ${PRODUCT_VERSION}.$\n¿Le gustaría continuar?"
!endif
...
LangString StrOcenPleaseCloseOcenaudio ${LANG_ENGLISH}		"${PRODUCT_NAME_LABEL} is running.$\nPlease close it before proceeding."
!ifndef OPT_REMOVE_LANGUAGES
LangString StrOcenPleaseCloseOcenaudio ${LANG_FRENCH}		"${PRODUCT_NAME_LABEL} est en marche.$\nS'il vous plaît le fermer avant de continuer."
LangString StrOcenPleaseCloseOcenaudio ${LANG_GERMAN}		"${PRODUCT_NAME_LABEL} läuft.$\nBitte schließen Sie es, bevor Sie fortfahren."
...
LangString StrOcenPleaseCloseOcenaudio ${LANG_PortugueseBR}	"O ${PRODUCT_NAME_LABEL} está em execução.$\nPor favor feche-o antes de prosseguir."
LangString StrOcenPleaseCloseOcenaudio ${LANG_SPANISH}		"${PRODUCT_NAME_LABEL} se está ejecutando.$\nPor favor, ciérrelo antes de continuar."
!endif


LangString StrOcenErrorCloseOcenaudio ${LANG_ENGLISH}		"Installation error.$\nPlease close ${PRODUCT_NAME_LABEL} and try again."
!ifndef OPT_REMOVE_LANGUAGES
LangString StrOcenErrorCloseOcenaudio ${LANG_FRENCH}		"Erreur dans l'installation.$\nS'il vous plaît proche ${PRODUCT_NAME_LABEL} et essayez à nouveau."
LangString StrOcenErrorCloseOcenaudio ${LANG_GERMAN}		"Fehler bei der Installation.$\nBitte schließen Sie ocenaudio und erneut versuchen."
LangString StrOcenErrorCloseOcenaudio ${LANG_ITALIAN}		"Errore di installazione.$\nChiudi ${PRODUCT_NAME_LABEL} e riprova."
LangString StrOcenErrorCloseOcenaudio ${LANG_PortugueseBR}	"Erro na instalação.$\nPor favor, feche o ${PRODUCT_NAME_LABEL} e tente novamente."
LangString StrOcenErrorCloseOcenaudio ${LANG_SPANISH}		"Error de instalación.$\nPor favor, cierre ${PRODUCT_NAME_LABEL} y vuelva a intentarlo."
!endif
